 ...
 */
@WebServlet("/NewUserServletAlternativo")
public class NewUserServletAlternativo extends HttpServlet {
	 ...
	 */
	public NewUserServletAlternativo() {
		users = new ArrayList<>();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("/index-alternativo.jsp");
